...
| `debugging` | Any bug, test failure, unexpected behavior | 500 |
...
## Skill Types
- **Rigid** (building, debugging, verification, receiving-review): Follow exactly. No shortcuts.
